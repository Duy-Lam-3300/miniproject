...
export default function FutureForecastBox({ data }) {
    ...
    return (
        <div className="flex flex-col items-center pt-6 pb-8 px-7 rounded-2xl w-full z-10 bgcomponent">
            ...
            <div className="w-full flex justify-center">
                <div className="text-[3.5rem] w-fit flex flex-col items-center relative bg-[rgb(225,225,225,0.1)] rounded-xl py-4 px-[2rem] pb-[5rem] mb-[6.5rem]  shadow-xl mt-8">
            ...
            <div className="w-full justify-between flex items-center select-none mt-4">
                <div className={`flex flex-col items-center gap-2  ${windDangerColor(data?.day?.maxwind_kph)}`}>
                ...
                <div className={`flex flex-col items-center gap-2 select-none  ${humidityDangerColor(data?.day?.humidity)}`}>
                    <div className="flex items-center gap-2">
